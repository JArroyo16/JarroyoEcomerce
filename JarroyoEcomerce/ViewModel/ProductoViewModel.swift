...
class ProductoViewModel{
    ...
    static func GetByNombre(Nombre : String) -> Result{
        ...
        var context = DBManger()
        var statement : OpaquePointer?
        var query = "SELECT IdProducto, Imagen, Nombre, Descripcion, PrecioUnitario FROM Producto WHERE Nombre LIKE '%\(Nombre)%'"
    ...
    static func GetByIdDep(IdDepartamento : Int) -> Result{
        var context = DBManger()
        var result = Result()
        var query = "SELECT IdProducto, Imagen, Nombre, Descripcion, PrecioUnitario FROM Producto WHERE IdDepartamento = \(IdDepartamento)"
        var statement : OpaquePointer?
